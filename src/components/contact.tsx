                ...
                <div className="grid divide-y border md:grid-cols-2 md:gap-4 md:divide-x md:divide-y-0">
                    <div className="flex flex-col justify-between space-y-8 p-6 sm:p-12">
                        <div>
                            ...
                            <p className="mt-3 text-sm">+91 93705 48470</p>
                        </div>
                    </div>
                    <div className="flex flex-col justify-between space-y-8 p-6 sm:p-12">
                        <div>
                            <h3 className="mb-3 text-lg font-semibold">Press</h3>
                            <Link href="https://wa.me/919370548470?text=hello" className="text-lg text-blue-600 hover:underline dark:text-blue-400">
                             contact
                            </Link>
                            <p className="mt-3 text-sm">Shaikh Fiazan</p>
                        </div>
                    </div>
                </div>
